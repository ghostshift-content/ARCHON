# Finding Validation Workflow — KRIPA

## Purpose
KRIPA receives POTENTIAL findings from specialist agents and either confirms them
(CONFIRMED) or rejects them (FALSE-POSITIVE) before passing to VYASA for reporting.
...
## Step 6 — Hand off to VYASA
- Notify KRISHNA that validation is complete
- Pass updated ACTIVITY-LOG to VYASA for report writing
