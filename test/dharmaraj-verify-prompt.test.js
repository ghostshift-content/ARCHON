...
// Guard: DHARMARAJ verification prompt must include
//   (a) both action + details (not just truncated action)
//   (b) VALIDATED-FINDINGS.jsonl structured block for pentest tasks
// These ensure DHARMARAJ has enough evidence to reproduce findings precisely
// instead of running generic probes. Regression guard for 2026-04-23 fix.
// Run: node /root/agents/test/dharmaraj-verify-prompt.test.js
...
console.log('DHARMARAJ verify-prompt tests:')
...
// (4) DHARMARAJ must NOT read the goal text (goal-leak isolation).
