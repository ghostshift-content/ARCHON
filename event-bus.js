...
{"id":"CR-<n>","title":"...","severity":"Critical|High|Medium|Low|Info","cvss_score":<number>,"cvss_vector":"CVSS:3.1/...","url":"<live URL if PROBER reproduced it, else empty string>","file":"<source path>","line":<number>,"affected_endpoint":"<route/action if known, else empty>","original_agent":"<phase2 specialist>","validation_status":"CONFIRMED|NEEDS-LIVE","confirmation_status":"RUNTIME_CONFIRMED|SOURCE_CONFIRMED|NEEDS_LIVE_VALIDATION","required_blackbox_proof":"<what a live test must observe to confirm this — for SOURCE_CONFIRMED/NEEDS-LIVE records that a white-box pentest should verify; else empty>","reproduction_method":"<file:line trace + curl/PROBER step if live>","reproduction_result":"<evidence>","taskId":"${taskId}","source":"code-review-normalizer"}
